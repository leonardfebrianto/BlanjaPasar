...
public class Alamat extends AppCompatActivity implements OnMapReadyCallback {
    ...
    /*============================================================================================*/
    public void getAlamatFromSession()
    {
        SharedPreferences pref = getApplicationContext().getSharedPreferences("MyPref", 0); // 0 - for private mode
        String a = pref.getString("sAlamat", "").toString();
        ti_alamat.setText(a);
    }

    /*============================================================================================*/
    public void setAlamatToSession()
    {
        ti_alamat = (EditText) findViewById(R.id.ti_alamat);
    ...
    public void onMapReady(final GoogleMap map) {
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragStart(Marker marker) {
                Toast.makeText(Alamat.this, "Dragging Start", Toast.LENGTH_SHORT).show();
            }
            /*--------------------------------------------------------*/
            @Override
